...
class SportsCirculars extends StatefulWidget {
  final faculty;

  const SportsCirculars({Key key, this.faculty}) : super(key: key);
  @override
  _SportsCircularsState createState() => _SportsCircularsState();
}

class _SportsCircularsState extends State<SportsCirculars> {
  @override
